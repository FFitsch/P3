...
\noindent This calculation was is done using all peak and trough pairs and its results are shown in Table \ref{tb_ne_excitation_energies}.
%
\begin{table}[H]
    \centering
    ...
    \begin{tabular}{
      ...
      |}
        \hline
         & \textbf{Peaks 1,2} & \textbf{Peaks 2,3} & \textbf{Troughs 1,2} & \textbf{Troughs 2,3}
        \\
        \hline
        \textbf{\(\Delta\)E [eV]} & 17.6 & 19.4 & 19.7 & 16.3
        \\
        \hline
    \end{tabular}
\end{table}
...
In order to calculate the total error of this result, two different error sources need to be evaluated.
